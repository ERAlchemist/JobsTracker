...
class ProspectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prospect" do
    assert_difference('Prospect.count') do
      post prospects_url, params: { prospect: { comment: @prospect.comment, job_title: @prospect.job_title, link: @prospect.link, location: @prospect.location, technologies: @prospect.technologies } }
    end
  ...
  test "should update prospect" do
    patch prospect_url(@prospect), params: { prospect: { comment: @prospect.comment, job_title: @prospect.job_title, link: @prospect.link, location: @prospect.location, technologies: @prospect.technologies } }
